...
namespace JPEG_EntropyCoderTests {
    ...
    public class HuffmanTreeTest {
        ...
        public static BitArray charsToBitArray(char[] input) {
        ...
        public static IEnumerable<Tuple<byte, BitArray>> FindGetTestCases() {
            ...
            foreach (string addr in addrs) {
                ...
                for (int i = 0; i < chars.Length - 1; i++) {
                  yield return new Tuple<byte, BitArray>(0xFF, charsToBitArray(chars.Take(i).ToArray()));
                }

                yield return new Tuple<byte, BitArray>(byte.Parse(addrc[0],System.Globalization.NumberStyles.HexNumber), charsToBitArray(chars));
            }
        }

        [Test, TestCaseSource("FindGetTestCases")]
        public void FindTest(Tuple<byte, BitArray> casetup) {
